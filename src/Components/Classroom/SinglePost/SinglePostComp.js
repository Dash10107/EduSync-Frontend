  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center mb-4 ">
        <div onClick={()=>{navigate(-1)}} className="bg-cover bg-center h-[20vh] w-full rounded-lg cursor-pointer" style={{ backgroundImage: `url('https://img.freepik.com/free-photo/blank-papers-multicolor-pencils-grey_114579-28815.jpg?size=626&ext=jpg&ga=GA1.1.1546980028.1708905600&semt=ais')` }}>
