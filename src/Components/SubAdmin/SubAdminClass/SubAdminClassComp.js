      ...
      <div className="flex-grow">
        ...
        <div className='flex'>
          ...
          <div className='lg:w-[80%] flex justify-center w-full'>
            <Main clasroom={clasroom} results={results}  forms={forms} teacherName={teacherName} studentNames={studentNames} fetchClassroom={fetchClassroom} />
          </div>
        </div>
      </div>
      <div className="">
...
export default SubAdminClassComp
